  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Historia del videojuego
        p.mb-4 Identificar los diferentes tipos de videojuegos  y su función, para utilizarlos en la creación y desarrollo de un juego, teniendo en cuenta la mecánica y otros elementos que se quieran recrear.
