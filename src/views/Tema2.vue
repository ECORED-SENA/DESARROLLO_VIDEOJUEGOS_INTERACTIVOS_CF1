...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
      ...
      .col-md-10
        .row.align-items-center.container-uno-color.p-4.mb-5(data-aos="fade-left" data-aos-delay="100" data-aos-duration="600")
          .col-12.col-lg-3.mb-4.mb-lg-0
            figure
              img(src="@/assets/curso/tema2-imagen1.svg" style="width: 200px").m-auto
          .col-12.col-lg-9
            h4 a. Hacer una lluvia de ideas
            p.mb-0 Comenzar con muchas ideas, pensando en una historia básica.  
              br
        ...
        .row.align-items-center.container-uno-color.claro.p-4.mb-5(data-aos="fade-right" data-aos-delay="200" data-aos-duration="600")
          .col-12.col-lg-3.mb-4.mb-lg-0
            figure
              img(src="@/assets/curso/tema2-imagen2.svg" style="width: 200px").m-auto
          .col-12.col-lg-9
            h4 b. Escoger la temática  
            p.mb-0 Se recomienda crear la temática a partir de las ideas más relevantes que surjan de la lluvia de ideas para armar su propia temática. Ejemplo temático: <i>Flynn</i>: niño perdido en un bosque, busca frutos para ayudar a su madre a curarse de una enfermedad terminal.
        .row.align-items-center.container-uno-color.p-4.mb-5(data-aos="fade-left" data-aos-delay="200" data-aos-duration="600")
          .col-12.col-lg-3.mb-4.mb-lg-0
            figure
              img(src="@/assets/curso/tema2-imagen3.svg" style="width: 200px").m-auto
          .col-12.col-lg-9
        ...
        .col-lg-5.container-juegos-blanco.p-4
          .row.justify-content-center
            .col-auto.px-2
              .titulo-sexto.color-acento-contenido.mb-2
                p.mb-0 #[b Figura 26]
                p.mb-0 Videojuego <strong><i>Do animals dream?</i></strong>
          figure.px-2
        ...
        .col-lg-5.container-juegos-blanco.p-4
          .row.justify-content-center
            .col-auto.px-2
              .titulo-sexto.color-acento-contenido.mb-2
                p.mb-0 #[b Figura 27]
                p.mb-0 Videojuego <strong><i>Little nightmares</i></strong>
          figure.px-2
    ...
    AcordionA.mb-5(tipo="b" clase-tarjeta="tarjeta tarjeta--gris")(data-aos="fade-left")
      ...
      .row.px-4(titulo="Estilo visual")
        .col-12.col-lg-6.mb-5.mb-lg-0
          p.mb-0 En este apartado es donde se decide la dirección artística del personaje y demás elementos, si se busca que se vea realista, para darle un enfoque más dramático, cercano a la realidad, con texturas y modelados detallados, o si se busca transmitir una sensación de fantasía y cuento de hadas, en cuyo caso, se optaría por un estilo tipo #[i cell shading], que transmita esa ambientación. Estilos minimalistas, tipo #[i cartoon] o #[i anime] entre otros.
        .col-12.col-lg-6
          .row.justify-content-center
            .col-auto
              .titulo-sexto.color-acento-contenido.mb-2
                p.mb-0 #[b Figura 28]
                p.mb-0 Aspecto visual juego <strong><i>Agent Intercept</i></strong>
          figure
          ...
          .col-12.col-lg-10
            .row.justify-content-center.mb-4
              .col-auto
                .titulo-sexto.color-acento-contenido.mb-2
                  p.mb-0 #[b Figura 30]
                  p.mb-0 Paleta de colores ejemplo de <strong><i>Super Mario Bros</i></strong>.
            figure
    ...
    TabsA.color-acento-contenido.mb-5(data-aos="fade-left")
      ...
      .tarjeta.color-primario.p-4(titulo="B. Características de la historia")
        ...
        ul.lista-ul--color
          li 
            i.fas.fa-gamepad(style="color: #8979F3")
            | #[b Fábula]. Trama o argumento que corresponde a la sucesión de eventos que se van a ir narrando y describiendo en la historia que se quiere contar. 
          li 
            i.fas.fa-gamepad(style="color: #8979F3")
            | #[b Personajes]. El segundo gran elemento de las historias son sus protagonistas y antagonistas, sin ellos no tendrían ningún sentido. De ellos depende el buen desarrollo de la historia, pues a su alrededor gira todo. El éxito de un videojuego siempre va a estar ligado a la profundidad de los personajes.
          li
            i.fas.fa-gamepad(style="color: #8979F3")
            | #[b Pensamiento]. Es el tema, es decir,  en qué se va a enfocar la historia dentro de los diferentes géneros: terror, comedia, policial, drama, entre otros. Se debe destacar una idea principal, como la venganza, el amor, la ecología, los zombis, los virus, la destrucción de la humanidad, etc. El tema de la historia, en cierta medida, establece la mecánica del juego, el contenido y su expresión artística; elementos que definen qué tan interesante será el videojuego.
          li 
            i.fas.fa-gamepad(style="color: #8979F3")
            | #[b Elocución o diálogo]. Le da importancia a lo que dicen los protagonistas, es decir, al tono de su voz, la forma como se expresan y el uso de las palabras; esto ayuda a crear una identidad única y singular a cada uno de ellos. Por ejemplo, un personaje científico se expresa de manera muy distinta a un personaje guerrero, demostrando diferentes capacidades intelectuales o culturales.
          li 
            i.fas.fa-gamepad(style="color: #8979F3")
            | #[b Melopeya]. La melodía o música tiene un enorme grado de importancia en la narrativa, ya que acompaña la creación y desarrollo de la historia y le da vida a través de la ambientación de los diferentes escenarios o niveles del videojuego, transmitiendo diferentes sensaciones o emociones al jugador.
      ...
      .tarjeta.color-primario.p-4(titulo="D. Progresión")
        ...
        ul.lista-ul--color
          li 
            i.fas.fa-gamepad(style="color: #8979F3")
            | #[b Deseos]. A través de situaciones que el jugador debe resolver, se provoca una sensación de agrado al alcanzar un logro, lo cual es fundamental para el mecanismo de retención.
          li 
            i.fas.fa-gamepad(style="color: #8979F3")
            | #[b Objetivos]. Son de tres tipos: de corto plazo, que básicamente es lo que se hace al jugar; mediano plazo, que hacen referencia a la acumulación de experiencia, ítems y demás elementos necesarios para alcanzar el último nivel, que sería el objetivo principal de largo plazo. Los objetivos de mediano plazo son de suma importancia, tanto para alcanzar el objetivo de largo plazo como para mantener el mecanismo de retención, pues son los que permiten la progresión.
          li 
            i.fas.fa-gamepad(style="color: #8979F3")
            | #[b Desafíos]. Son retos o pruebas que deben ir siempre un paso adelante de la habilidad actual del jugador, ya que este va mejorando con el tiempo y la práctica; por lo tanto, los desafíos también deben mantener el interés a medida que el jugador progresa.
          li 
            i.fas.fa-gamepad(style="color: #8979F3")
            | #[b Progresión]. Se trata de brindar al jugador la sensación de avance, permitiéndole trasladar su experiencia, ítems y demás recompensas a lo largo del juego, gracias a su naturaleza, el formato, o el dispositivo electrónico que permite guardar el progreso de la partida. El sistema de progresión permite acumular puntos de experiencia, lo que le posibilita al jugador subir de nivel y acceder a nuevos desafíos y mejores recompensas; por ello, es necesario ir intensificando el juego de manera fluida, equilibrada y progresiva, de forma tal que no se vuelva tan difícil para que el jugador no se frustre, ni tan fácil para que no se aburra.
          li 
            i.fas.fa-gamepad(style="color: #8979F3")
            | #[b Recompensas (el #[i score], títulos, logros y demás)]. Provocan que el jugador disfrute y explore más y se sienta mejor a medida que progresa, aunque no son la principal razón por la que las personas juegan, a excepción de algunos videojuegos de tipo abstracto que carecen de una historia que desarrollar.
    ...
    .row.justify-content-center.mb-5(data-aos="fade-left")
      ...
      .col-md-10.col-lg-6.d-flex(data-aos="slide-left" data-aos-delay="250" data-aos-duration="600" data-aos-offset="200")
            ...
            .col-lg-6.mb-4.mb-md-0
              .cajon.color-acento-contenido.p-4.mb-4
                ul.lista-ul--color.change
                  li 
                    i.fas.fa-gamepad(style="color: #8979F3")
                    | #[b Luz directa]. Es la luz que se emite desde una fuente propia, por ejemplo, el sol, bombillos, antorchas.
                  li 
                    i.fas.fa-gamepad(style="color: #8979F3")
                    | #[b Luz reflejada]. Es la luz que se recibe de un cuerpo u objeto que la refleja, pero no es propia de él; un ejemplo de ello serían las luces que llegan a los objetos luego de rebotar en superficies metálicas.
                  li 
                    i.fas.fa-gamepad(style="color: #8979F3")
                    | #[b Dirección de la luz]. Es la posición del foco de luz con respecto al elemento que vamos a iluminar.
                  li 
                    i.fas.fa-gamepad(style="color: #8979F3")
                    | #[b Luz frontal]. Situada frente al objeto.
            .col-lg-6
              .row.justify-content-center.mb-4
                .col-auto
                  .titulo-sexto.color-acento-contenido.mb-2
            ...
            .col-lg-6.mb-4.mb-md-0
              .cajon.color-acento-contenido.p-4.mb-4
                ul.lista-ul--color.change
                  li 
                    i.fas.fa-gamepad(style="color: #8979F3")
                    | #[b Luz lateral]. Situada a alguno de los lados del objeto.
            .col-lg-6
              .row.justify-content-center.mb-4
                .col-auto
                  .titulo-sexto.color-acento-contenido.mb-2
              ...
              .cajon.color-acento-contenido.p-4.mb-4
                ul.lista-ul--color.change
                  li 
                    li 
                    i.fas.fa-gamepad(style="color: #8979F3")
                    | #[b Luz cenital]. Situada arriba del objeto.
            .col-lg-6
              .row.justify-content-center.mb-4
                .col-auto
                  .titulo-sexto.color-acento-contenido.mb-2
            ...
            .col-lg-6.mb-4.mb-md-0
              .cajon.color-acento-contenido.p-4.mb-4
                ul.lista-ul--color.change
                  li 
                    i.fas.fa-gamepad(style="color: #8979F3")
                    | #[b Contraluz]. Esta luz se sitúa detrás del objeto.
            .col-lg-6
              .row.justify-content-center.mb-4
                .col-auto
                  .titulo-sexto.color-acento-contenido.mb-2
            ...
            .col-lg-6.mb-4.mb-md-0
              .cajon.color-acento-contenido.p-4.mb-4
                ul.lista-ul--color.change
                  li 
                    i.fas.fa-gamepad(style="color: #8979F3")
                    | #[b Luz dura]. Se genera por una fuente con foco intenso, esta va a generar sombras más marcadas y más oscuras.
            .col-lg-6
              .row.justify-content-center.mb-4
                .col-auto
                  .titulo-sexto.color-acento-contenido.mb-2
            ...
            .col-lg-6.mb-4.mb-md-0
              .cajon.color-acento-contenido.p-4.mb-4
                ul.lista-ul--color.change
                  li 
                    i.fas.fa-gamepad(style="color: #8979F3")
                    | #[b Luz suave]. Se genera cuando la fuente de luz se extiende y se dispersa, como sería el caso de los rayos del sol filtrados por nubes, o una bombilla con un pedazo de tela, o una lámpara, lo cual hace que la luz se difumine y produzca sombras transparentes no tan <strong>perceptibles</strong> como con la luz dura.
            .col-lg-6
              .row.justify-content-center.mb-4
                .col-auto
                  .titulo-sexto.color-acento-contenido.mb-2
          ...
          .col-lg-6.mb-4.mb-md-0
            ...
            .cajon.color-acento-contenido.p-4.mb-4
              ul.lista-ul--color.change
                li 
                  i.fas.fa-gamepad(style="color: #8979F3")
                  | #[b Sombras propias]. Son las sombras que se encuentran en los objetos, en las partes del mismo donde la luz no alcanza a llegar.
                li 
                  i.fas.fa-gamepad(style="color: #8979F3")
                  | #[b Sombras proyectadas]. Son las sombras que un objeto proyecta sobre la superficie donde se encuentra estacionado.
                li 
                  i.fas.fa-gamepad(style="color: #8979F3")
                  | #[b Sombras reflejada]. Son las sombras que el objeto genera en otro objeto cercano a este.
          .col-lg-6
            .row.justify-content-center.mb-4
              .col-auto
                .titulo-sexto.color-acento-contenido.mb-2
        ...
        .caja-texto.color-primario.p-5
          .row.mb-3
            .col-3
              .line-selector-text.color-acento-contenido
          p.mb-0
            strong Elliott Avedon (2005), en su libro <i>The Study of the Games</i>, menciona diez <i>tips</i> para tener más claridad acerca de las mecánicas. 
            br
            br
        ...
        .row.justify-content-center
          .col-11.col-md-10.col-lg-10
            ...
            .row.align-items-center.container-uno-color.p-4.mb-5(data-aos="fade-right")
              ...
              .col-12.col-lg-9.mb-5.mb-lg-0
                h4 Construcción
                p Dinámicas en que la acción principal es que, para avanzar, se necesita crear elementos que influyen en el entorno. Ejemplo de estos juegos son <strong><i>Dragon quest builders, Minecraft</i></strong>.
            .row.align-items-center.container-uno-color.claro.p-4.mb-5(data-aos="fade-left")
              .col-12.col-lg-3.mb-4.mb-lg-0
                figure
              ...
              .col-12.col-lg-9.mb-5.mb-lg-0
                h4 Colección
                p En esta dinámica, la finalidad es recolectar ciertos elementos para poder avanzar o ganar la partida. Se usa frecuentemente en juegos de plataforma, donde, para avanzar de nivel, se tiene que recolectar elementos como monedas o estrellas. Ejemplo de ello son juegos como <strong><i>Little Big Planet</i></strong>.
            .row.align-items-center.container-uno-color.p-4.mb-5(data-aos="fade-right")
              .col-12.col-lg-3.mb-4.mb-lg-0
                figure
              ...
              .col-12.col-lg-9.mb-5.mb-lg-0
                ...
                p Juegos en los que la finalidad es capturar o escapar de otros elementos o personajes. Se puede resaltar un juego como <i>Pac-Man</i>, u otros más recientes que usan esta dinámica, como <strong><i>Grand Theft Auto</i></strong> o <strong><i>Saints Row</i></strong>.
            .row.align-items-center.container-uno-color.claro.p-4.mb-5(data-aos="fade-left")
              .col-12.col-lg-3.mb-4.mb-lg-0
                figure
              ...
              .col-12.col-lg-9.mb-5.mb-lg-0
                h4 Carreras
                p Son juegos que, como su nombre lo indica, su dinámica principal es llegar a la meta en primera posición. Entre este tipo de juegos, se pueden mencionar ejemplos como <strong><i>Mario Kart</i></strong> o <strong><i>Drift</i></strong>.
    ...
    ul.lista-ul--color.mb-5(data-aos="fade-left")
      ...
      li 
        i.fas.fa-gamepad(style="color: #8979F3")
        | Luego, se deben crear los límites espaciales, como paredes o muros. Estos no pueden ser atravesados, a menos que el personaje tenga el poder de traspasarlas.  
      li 
        i.fas.fa-gamepad(style="color: #8979F3")
        | Tener los elementos que le dan vida al ambiente y que son fijos: un árbol, una piedra, etc. Estos no se pueden atravesar, pero se puede pasar frente a ellos. 
      li 
        i.fas.fa-gamepad(style="color: #8979F3")
          ...
          .col-lg-11
            .pt-2.pb-1.ps-4.pe-4.container-title
              .row.align-items-center
                .col-lg-8.mb-4.mb-lg-0
                  p.mb-0 En la figura 43, de <strong><i>Megaman</i> 10</strong>, se puede observar el recorrido de principio a fin.
                .col-lg-4
                  .titulo-sexto.color-acento-contenido.mb-0
                    p.mb-0 #[b Figura 43]
                    p.mb-0 Ejemplo uno, escenario <strong><i>Megaman</i> 10</strong>
          figure                        
        ...
        .row.justify-content-center.m-1
          .col-lg-11
            .pt-2.pb-1.ps-4.pe-4.container-title
              .row.align-items-center
                .col-lg-8.mb-4.mb-lg-0
                  p.mb-0 En el siguiente fragmento de la figura 44, de <strong><i>Megaman</i> 10</strong>, se puede observar uno de los espacios por donde debe pasar #[i Megaman], aquí inicia la historia y el personaje realiza saltos para poder avanzar al siguiente nivel.
                .col-lg-4
                  .titulo-sexto.color-acento-contenido.mb-0
                    p.mb-0 #[b Figura 44]
                    p.mb-0 Ejemplo dos, escenario <strong><i>Megaman</i> 10</strong>
            figure
                ...
                .pt-2.pb-1.ps-4.pe-4.container-title.bottom
                  .row.justify-content-center
                    .col-auto
                      .titulo-sexto.color-acento-contenido.mb-0
                        p.mb-0 #[b Figura 45]
                        p.mb-0 Ejemplo tres, escenario <strong><i>Megaman</i> 10</strong>
        .row.justify-content-center.m-1
          .col-lg-6
            .row.justify-content-center
              .col-11
                ...
                .pt-2.pb-1.ps-4.pe-4.container-title.bottom
                  .row.justify-content-center
                    .col-auto
                      .titulo-sexto.color-acento-contenido.mb-0
                        p.mb-0 #[b Figura 46]
                        p.mb-0 Ejemplo cuatro, nivel final <strong><i>Megaman</i> 10</strong>
        .row.justify-content-center.m-1
          .col-lg-6
            .row.justify-content-center
              .col-11
